...
public class ArrayListMethods {
    ...
    /**
     * Determines if the array list is sorted (do not sort) When Strings are
     * sorted, they are in alphabetical order Use the compareTo method to
     * determine which string comes first You can look at the String compareTo
    ...
    /**
     * Replaces all but the first and last elements with the larger of its two
     * neighbors You can use the compareTo() method to determine which string is
     * larger (larger in alphabetical order). Example: if the list is originally
     * ["cat", "ape", "dog", "horse", "zebra"] after this method it should be:
     ...
     * duplicate once. Start at index 0. (Does it match any of the other
     * elements?) Get the next word. It is at index i. (Does it match any of the
     * words with index > i?)
     *
    ...
    /**
     * Moves any word that starts with x, y, or z to the front of the ArrayList,
     * but otherwise preserves the order Example: if the list is orginially
     * ["ape", "dog", "xantus", "zebra", "cat", "yak"] after this method is
     * called it should be ["xantus", "zebra", "yak", "ape", "dog", "cat"]
     */
     ...
     *
     * @returns the string representation of this array list in standard
     * collection format
     */
