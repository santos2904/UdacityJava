...
public class Word
{
	...
	private int length;
		...
		public Word (String word) //TODO write the constructor and define the instance variable
	{
		this.word = word;
    ...
    public String getSubstrings()
    {
        ...
        for (int i = 1; i <= length; i++)
        {
            ...
            {
                substring = substring + word.substring(j, i + j) + "\n";
            }
        }
       return substring; //TODO implement this method
    }
}
