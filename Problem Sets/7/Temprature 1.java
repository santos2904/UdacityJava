...
public class TemperatureNormalizer {
    ...
    /**
     * Gets the adjusted average of the values in this array. The adjusted
     * average is calculated by removing the highest and lowest values and
     * calculating the average of the values that are left
     *
    ...
    public double getAdjustedAverage() {
        ...
        adjustedAverage = (getSum() - getMax() - getMin()) / (data.length - 2);
